const leagueDescMap: { [key: string]: string } = {
    ...
    "premier_league": "The oldest league in the world, the English championship has been played since 1888. The title, however, has been challenged since 1871, in the FA Cup. Liverpool is the current record holder.",
